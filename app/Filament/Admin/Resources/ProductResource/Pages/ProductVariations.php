...
class ProductVariations extends EditRecord
{
    ...
    private function mergeCartesianWithExisting($variationTypes, $existingData): array
    {
        ...
        $cartesianProduct = $this->cartisianProduct($variationTypes, $defaultQuantity, $defaultPrice);
    ...
    private function cartisianProduct($variationTypes, $defaultQuantity = null, $defaultPrice = null): array
    {
        $result = [[]];
